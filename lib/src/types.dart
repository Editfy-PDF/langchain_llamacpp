...
class ChatLlamaOptions extends ChatModelOptions {
  ...
  @override
  ChatLlamaOptions merge(covariant final ChatLlamaOptions? other) {
    return copyWith(
      model: other?.model,
      mmproj: other?.mmproj,
  ...
  @override
  bool operator ==(covariant final ChatLlamaOptions other) {
